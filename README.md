...
**Global Waves** is a Java backend for a scalable music streaming platform similar to Spotify. It simulates various user interactions within an audio application. Multiple users can interact with the app simultaneously, with an admin managing their activities. It supports 500+ concurrent users, content pages, user profiles, playback options, search & filtering, analytics, and ad monetization.
